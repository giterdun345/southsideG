  ...
  return (
    ...
    <div style={{width:'90%', margin:'auto'}}>
      ...
      <h4>Definitions</h4>
        ...
        <p>Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Southside Paint + More, 2055 Derham Road Jacksonville, Florida 32246.</p>
        ...
        <p>Website refers to Southside Paint + More, accessible from<a href='https://www.southsidepaintplusmore.com/'>https://www.southsidepaintplusmore.com/</a> </p>
      ...
      <h4>Tracking Technologies and Cookies</h4>
        ...
        <h5>Cookies can be "Persistent" or "Session" Cookies</h5>
        <p>Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies: Cookies: What Do They Do?.</p>
      ...
      <ul>
        <li>By email: <a href='mailto:Sspaintnmore@outlook.com'>Sspaintnmore@outlook.com</a> </li>
        <li>By visiting this page on our website: <a href='https://www.southsidepaintplusmore.com/'>https://www.southsidepaintplusmore.com/</a></li>
